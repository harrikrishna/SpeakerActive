...
class GlobalThings: ObservableObject {
    ...
    init(){
        ...
        disableSleepTimer = UserDefaults.standard.bool(forKey: "Disable Sleep Timer")
    ...
    @Published var disableSleepTimer = false { didSet {
        UserDefaults.standard.set(disableSleepTimer, forKey: "Disable Sleep Timer")
    }}
